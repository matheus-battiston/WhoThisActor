...
class ProvidersServiceTest {
    ...
    void deveBuscarProvidersDeFilmeNaUrlCorreta() {
        ...
        try (MockedConstruction<RestTemplate> restTemplates = mockConstruction(RestTemplate.class)) {
            ProvidersService service = criarService();
            RestTemplate restTemplate = restTemplates.constructed().get(0);
    ...
    private ProvidersService criarService() {
        ProvidersService service = new ProvidersService();
