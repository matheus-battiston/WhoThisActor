...
import FavoritoAtorWebCard from "../../../components/favorito-ator-web-card/favorito-ator-web-card.component";
import FavoritoProducaoWebCard from "../../../components/favorito-producao-web-card/favorito-producao-web-card.component";
  ...
  return (
    <div className="favoritos-web">
      <main className="favoritos-web-conteudo">
        ...
        <header className="favoritos-web-secao-header">
          <span>
            <IconeSecao />
